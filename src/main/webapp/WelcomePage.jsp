	...
	<div class="bg3">
		<div >
			...
			<form>
				<table class="avo">
					<tr>
						<td bgcolor="#6699cc" align="center"><p style="color:black;font-size:14px;">Account Number</p></td>
						<td bgcolor="#6699cc" align="center"><p style="color:black;font-size:14px;">Account Holder Name</p></td>
						<td bgcolor="#6699cc" align="center"><p style="color:black;font-size:14px;">Account Type</p></td>
						<td bgcolor="#6699cc" align="center"><p style="color:black;font-size:14px;">Account Balance</p></td>
					</tr>
					<tr>
						<td bgcolor="#8cb3d9" align="center"><p style="color:black;font-size:20px;">${user.accno}</p></td>
						<td bgcolor="#8cb3d9" align="center"><p style="color:black;font-size:20px;">${user.uname}</p></td>
						<td bgcolor="#8cb3d9" align="center"><p style="color:black;font-size:20px;">${user.acctype }</p></td>
						<td bgcolor="#8cb3d9" align="center"><p style="color:black;font-size:20px;">${user.amt}</p></td>
					</tr>
				</table>
			</form>
			</div>
					...
					<tr>
						<td>
							<form action="requestloan" method="post">
								<input class="button btn btn-default button3" type="submit"
