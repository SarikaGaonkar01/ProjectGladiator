	...
	<div class="searchform">
		...
		<div class="abso">
				...
				<table border="1">
					...
					<c:forEach var="employee" items="${list}">
						<tr>
							...
							<td><form action="deletePayee" method="get">
							<input class="button btn btn-default button3" type="hidden" name="ga_payee_accno" value=${employee.ga_payee_accno}>
				...
				<form action="returnHome" method="post">
				  <input class="button btn btn-default button3" type="submit" value="DashBoard">
				</form>
			</div>
			</div>
