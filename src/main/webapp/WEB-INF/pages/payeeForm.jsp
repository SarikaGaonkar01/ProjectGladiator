				...
				<table>
					<tr>
						...
						<td colspan="2" bgcolor="#80002a">
							<h1 style="color: #e0e0eb" align="center">Add Payee</h1>
						</td>
					</tr>
					<tr>
						<td colspan="2"><br></td>
					...
					<tr>
						...
						<td><div class="input-group">
								<span class="input-group-addon"><i class="fa fa-user fa"
									aria-hidden="true"></i></span> <input type="text" name="ga_payee_name"
									class="form-control" placeholder="Enter Payee Name"
									title="Payee Name Is required" required pattern="[A-Za-z]{5,20}"/>
							</div></td>
					...
					<tr>
						<td align="right">Payee Bank IFSC Code:&nbsp;</td>
						<td><div class="input-group">
								<span class="input-group-addon"><i class="fa fa-user fa"
									aria-hidden="true"></i></span> <input type="text" name="ga_payee_acc_ifsc"
									class="form-control" placeholder="Enter Payee IFSC Code"
									title="Payee IFSC Code Is required" required pattern="[A-Z]{4}+[0-9]{6}"/>
							</div></td>
					...
					<tr>
						<td align="right">Payee Bank Account no:&nbsp;</td>
						<td><div class="input-group">
								<span class="input-group-addon"><i class="fa fa-user fa"
									aria-hidden="true"></i></span> <input type="text" name="ga_payee_accno"
									class="form-control" placeholder="Enter Account number"
									title="Proper Account number Is required" required pattern="[0-9]{16}"/>
							</div></td>
