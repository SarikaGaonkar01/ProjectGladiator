				...
				<tr>
					...
					<td>
						<form action="neftTransfer" method="post">
							<input class="button btn btn-default button3" type="submit" value="Money Transfer">
						</form>
					</td>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td>
						<form action="TransferLog" method="post">
							<input class="button btn btn-default button3" type="submit" value="Transfer Log">
						</form>
					</td>
				</tr>
